        ...
        with conn.cursor() as cursor:
                ...
                if user:
                    ...
                    if role == 'inventory clerk':
                        return render_template("main_menu.html", user={'is_inventory_clerk': True, 'username': username}, available_vehicle=available_vehicle, parts_pending=parts_pending, results = results)

                    elif role == 'owner':
                        return render_template("main_menu.html", user={'is_owner': True, 'username': username}, available_vehicle=available_vehicle, parts_pending=parts_pending, results = results)
                        ...
                        <body>
                            <div class="center">
                                ...
                                <form action="/search_owner" method="POST">
                        ...
                        return render_template("main_menu.html", user={'is_manager': True, 'username': username}, available_vehicle=available_vehicle, parts_pending=parts_pending, results = results)


                    elif role == 'salesperson':
                        # Redirect salesperson to main page where they can search vehicles by VIN
                        return render_template("main_menu.html", user={'is_salesperson': True, 'username': username}, available_vehicle=available_vehicle, results = results)

                    else:
                        return render_template("main_menu.html", user={'is_public': True, 'username': username}, available_vehicle=available_vehicle, results = results)
